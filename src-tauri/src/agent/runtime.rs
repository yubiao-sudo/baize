                    ...
                    if ok
                        && matches!(
                            ...
                            "click_at" | "mouse_click" | "click_element" | "mouse_drag" | "close_popup"
                                | "wheel_scroll" | "hover" | "paste_text" | "type_text"
                        )
                    {
